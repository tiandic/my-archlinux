...
if [[ "$cpu_info" == *"Intel"* ]]; then
  pacman -S --noconfirm --needed mesa lib32-mesa vulkan-intel lib32-vulkan-intel intel-ucode
else
  pacman -S --noconfirm --needed mesa lib32-mesa vulkan-radeon lib32-vulkan-radeon amd-ucode
fi
